...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('../image/bird.jpg');
    ...
    <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="filter-card">
                    <h2 class="text-center mb-4" style="color: #ff7f50;">Filter Birds by Breed</h2>
                    <form method="GET" action="" class="filter-form">
                        <div class="form-group">
                            <label for="filter_breed" class="text-white">Select Breed</label>
                            <select name="breed_name" id="filter_breed" class="form-control input-field">
            ...
            <div class="col-md-8">
                <h1 class="text-right mb-4" style="color: #ff7f50;">Available Birds</h1>
                <div class="row">
                    <?php
                    // Build query
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        echo "<p class='text-center w-100'>No birds found matching the selected filters.</p>";
                    }
                    ?>
                </div>
            </div>
